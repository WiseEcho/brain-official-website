    ...
    new Map<string, ResourcePropsType>([
      [
        '首页素材1',
        {
          ...
          img: '/home/images/resource/resource-1.png',
            ...
            data: [
              {
                ...
                defaultIndex: 1,
                showUrl: '/home/images/home/内容中台.png',
                index: '1',
              },
              {
                title: '工作协同',
                ...
                defaultIndex: null,
                showUrl: '/home/images/home/工作协同.png',
                index: '2',
              },
              {
                title: '智能投放',
                ...
                defaultIndex: null,
                showUrl: '/home/images/home/智能投放.png',
                index: '3',
              },
              {
                title: '数据复盘',
                ...
                defaultIndex: null,
                showUrl: '/home/images/home/数据复盘.png',
                index: '4',
              },
            ],
            mode: 'vertical',
      ...
      [
        '首页素材3',
        {
          ...
          img: '/home/images/resource/resource-3.png',
          title: '激活上下游搭建高效团队',
          header: true,
        },
      ],
          ...
          attr: {
            data: {
              ...
              list: [
                {
                  label: '本地存储',
                  url: '/home/images/content/local-storage.png',
                },
                {
                  label: '精准检索',
                  url: '/home/images/content/search.png',
                },
                {
                  label: '素材共享',
                  url: '/home/images/content/resource-share.png',
                },
                {
                  label: '批量上传',
                  url: '/home/images/content/batch-upload.png',
                },
                {
                  label: '审核批注',
                  url: '/home/images/content/comment.png',
                },
                {
                  label: '内容复盘',
                  url: '/home/images/content/content.png',
                },
              ],
              size: 'large',
            },
      ...
      [
        '产品素材2',
        {
          ...
          img: '/home/images/swiper/工作协同.png',
          title: '工作协同',
          header: true,
        },
      ],
      [
        '产品素材3',
        {
          ...
          img: '/home/images/swiper/智能投放.png',
          title: '智能投放',
          header: true,
          attr: {},
        },
      ...
      [
        '产品素材4',
        {
          ...
          img: '/home/images/swiper/数据复盘.png',
          title: '数据复盘',
          header: true,
        },
      ],
            ...
            data: [
              {
                ...
                img: '/home/images/accordion/accordion-1.svg',
                isCollapse: false,
              },
              {
                title: '本地交付',
                desc: '专属顾问协助梳理业务流程&权限架构，制定部署方案',
                img: '/home/images/accordion/accordion-2.svg',
                isCollapse: true,
              },
              {
                title: '一对一服务',
                desc: '专属顾问为您提供一对一使用咨询服务，并定期回访提供使用培训服务',
                img: '/home/images/accordion/accordion-3.svg',
                isCollapse: true,
              },
              {
                title: '持续产品迭代',
                desc: '根据业务需求不断优化迭代产品',
                img: '/home/images/accordion/accordion-4.svg',
                isCollapse: true,
              },
            ],
          },
